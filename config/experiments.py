...
# NDE head only embedding experiments
    ...
    "finetune_direct_embeddings_9param_nle": {
        ...
        "inference_mode": "nle",
        "load_pretrained_flow": True,
        "pretrained_band_ckpt_path": "/share/gpu5/asaoulis/transfer_models/checkpoints/glass_embeddings_9param_nle/",
        "max_trainval_cosmos": [30, 40, 60, 80, 100, 120, 150, 200, 300, 400, 530],
        "train_frac":0.7,
        "val_frac":0.2,
    },
